...
// 4. Check if a number is even without mod operator.
...
// 14. Find the greatest common divisor (gczzzzzzzzzzzzzzzzzzzzzzzzzzzd) of two positive numbers. The GCD of two
...
var fizzBuzz = function(n) {
  ...
  return fizzBuzz(n - 1).concat(n % 3 === 0 && n % 5 === 0 ? 'FizzBuzz' : n % 3 === 0 ? 'Fizz' : n % 5 === 0 ? 'Buzz' : n.toString());
};
...
var countKeysInObj = function(obj, key) {
  ...
  for (var attr in obj) {
    ...
    if (obj[attr] instanceof Object) {
      count += countKeysInObj(obj[attr], key);
    }
  }
  return count;
};
...
var capitalizeFirst = function(array) {
  ...
  return [array[0][0].toUpperCase() + array[0].slice(1, array[0].length)].concat(capitalizeFirst(array.slice(1)));
};
